  ...
  return (
    <div className="Wrap">
      <div className="Container">
        <div className="Title">
          <img className="Title-logo" src="https://raw.githubusercontent.com/etoyadadaya/kinopoisk/master/src/common/favicon.ico" alt=""></img>
          <div>
            <h1 className="Title-h1">Welcome to Gensetix</h1>
            <h2 className="Title-h2">Log in to sync your content</h2>
          </div>
        </div>
        <div className="Signup">
          <Button to="/google">
            <svg viewBox="0 0 20 20" className="Logo">
              <g>
                <path
          ...
          <Button to="/apple">
            <svg viewBox="0 0 170 170" className="Logo">
              <path
        ...
        <div className="Links">
          ...
          <Link className="Link" to="/">You can also continue with SAML SSO</Link>
        </div>
      </div>
    </div>
  );
